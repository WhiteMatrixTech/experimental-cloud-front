  ...
  return (
    <Modal {...drawerProps}>
      <Form layout="vertical" form={form}>
        <Item
          label={Intl.formatMessage('BASS_ONE_KEY_COMPILE_REPOSITORY_ADDRESS')}
          name="gitRepoUrl"
          initialValue=""
          rules={[
            {
              required: true,
              message: Intl.formatMessage('BASS_ONE_KEY_COMPILE_INPUT_REPOSITORY_ADDRESS')
            }
          ]}>
          <Input placeholder={Intl.formatMessage('BASS_ONE_KEY_COMPILE_INPUT_REPOSITORY_ADDRESS')} />
        </Item>
        <Item
