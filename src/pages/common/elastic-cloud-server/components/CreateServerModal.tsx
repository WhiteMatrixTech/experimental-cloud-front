  ...
  return (
    <Modal {...drawerProps}>
      <Form {...formItemLayout} form={form}>
        ...
        <Item
          label={Intl.formatMessage('BASS_ELASTIC_CLOUD_EXTERNAL_IP')}
          name="publicIp"
          initialValue={(record && record.publicIp) || ''}
          rules={[
            {
              required: true,
              message: Intl.formatMessage('BASS_ELASTIC_CLOUD_INPUT_EXTERNAL_IP')
            }
          ]}>
          <Input placeholder={Intl.formatMessage('BASS_ELASTIC_CLOUD_INPUT_EXTERNAL_IP')} />
        </Item>
        <Item
