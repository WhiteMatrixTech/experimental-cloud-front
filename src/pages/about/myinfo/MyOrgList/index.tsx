...
breadCrumbItem.push({
  menuName: Intl.formatMessage('BASS_ORGANSIZATION_INFORMATION'),
  menuHref: `/`
});
...
function MyOrgInfo(props: MyOrgInfoProps) {
  ...
  const myOrgInfoList: DetailViewAttr[] = [
    ...
    {
      label: Intl.formatMessage('BASS_ORGANSIZATION_MSP'),
      value: myOrgInfo && myOrgInfo.orgMspId
    },
    {
      label: Intl.formatMessage('BASS_ORGANSIZATION_ADDRESS'),
      value: myOrgInfo && myOrgInfo.orgAddress
    },
    {
      label: Intl.formatMessage('BASS_ORGANSIZATION_STATUS'),
    ...
    <div className="page-wrapper">
      ...
      <div className="page-content">
        <Spin spinning={qryLoading}>
          <DetailCard cardTitle={Intl.formatMessage('BASS_ORGANSIZATION_INFORMATION')} detailList={myOrgInfoList} />
        </Spin>
      </div>
    </div>
  );
