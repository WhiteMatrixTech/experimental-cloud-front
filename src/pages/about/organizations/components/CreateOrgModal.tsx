      ...
      <Form {...formItemLayout} form={form}>
        ...
        <Item
          ...
          rules={[
            {
              required: true,
              message: Intl.formatMessage('BASS_ORGANIZATION_INPUT_NAME')
            },
            {
              min: 4,
              max: 20,
              ...
              message: Intl.formatMessage('BASS_ORGANIZATION_NAME_LENGTH')
            }
          ]}>
          <Input placeholder={Intl.formatMessage('BASS_ORGANIZATION_INPUT_NAME')} />
        </Item>
        <Item
          ...
          rules={[
            {
              required: true,
              message: Intl.formatMessage('BASS_ORGANIZATION_INPUT_ALIAS')
            }
          ]}>
          <Input placeholder={Intl.formatMessage('BASS_ORGANIZATION_INPUT_ALIAS')} />
        </Item>
        <Item
          label={Intl.formatMessage('BASS_ORGANIZATION_INITIALIZE_NODE_NAME')}
          name="initPeerName"
          initialValue=""
          rules={[
            {
              required: true,
              message: Intl.formatMessage('BASS_ORGANIZATION_INPUT_INITIALIZE_NODE_NAME')
            },
            {
              min: 4,
              max: 20,
              type: 'string',
              pattern: /^[a-zA-Z0-9]{4,20}$/,
              message: Intl.formatMessage('BASS_ORGANIZATION_INITIALIZE_NODE_ALIASES_LENGTH')
            }
          ]}>
          <Input placeholder={Intl.formatMessage('BASS_ORGANIZATION_INPUT_INITIALIZE_NODE_NAME')} />
        </Item>
        <Item
          label={Intl.formatMessage('BASS_ORGANIZATION_INITIALIZE_NODE_ALIASES')}
          name="initPeerAliasName"
          rules={[
            {
              required: true,
              message: Intl.formatMessage('BASS_ORGANIZATION_INPUT_INITIALIZE_NODE_ALIASES')
            }
          ]}>
          <Input placeholder={Intl.formatMessage('BASS_ORGANIZATION_INPUT_INITIALIZE_NODE_ALIASES')} />
        </Item>
        <Item
