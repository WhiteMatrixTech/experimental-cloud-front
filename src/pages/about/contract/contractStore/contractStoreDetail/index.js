      ...
      <div className='page-wrapper'>
        ...
        <div className='page-content'>
          ...
          <div className='table-header-btn-wrapper'>
            <Button type='primary' onClick={this.onClickDeploy}>部署合约</Button>
          </div>
          <Table
            rowKey='_id'
            loading={qryLoading}
        ...
        {fieldDescVisible && <FieldDesc visible={fieldDescVisible} record={record} onCancel={this.onCloseFieldDescModal} />}
        {deployContractVisible && <DeployContract visible={DeployContract} record={curRepository} onCancel={this.onCloseDeployModal} />}
      </div >
    )
  }
}
