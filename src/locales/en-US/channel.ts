export const CHANNEL_US = {
  ...
  BASS_CHANNEL_INPUT_NAME: 'Please input the channel name',
  ...
  BASS_CHANNEL_DESCRIBE: 'Channel Description',
  BASS_CHANNEL_INPUT_DESCRIBE: 'Please input the channel describe',
  BASS_CHANNEL_DESCRIBE_LENGTH: 'The channel description consists of 0 to 300 characters',
  BASS_CHANNEL_CREATOR: 'Creator',
  BASS_CHANNEL_VIEW_ORGANIZATION: 'View Organizations',
  BASS_CHANNEL_VIEW_NODE: 'View Nodes',
  BASS_CHANNEL_VIEW_CONTRACT: 'View Contracts',
  ...
  BASS_CHANNEL_ORGANIZATION: 'Organization',
