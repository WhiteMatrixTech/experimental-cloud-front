export const NOTIFICATION_US = {
  ...
  BASS_NOTIFICATION_CHANNEL_ADD_ORGANIZATION_SUCCESS: 'Succeed in calling add Organization api',
  BASS_NOTIFICATION_CHANNEL_ADD_ORGANIZATION_FAILED: 'Failed to call add Organization api',
  ...
  BASS_NOTIFICATION_CONTRACT_CALLING_SUCCESS: 'Succeed in calling contract',
  BASS_NOTIFICATION_CONTRACT_CALLING_FAILED: 'Failed to call contract',
  BASS_NOTIFICATION_CUSTOM_IMAGE_ADD_SUCCESS: 'Add custom image successfully',
  BASS_NOTIFICATION_CUSTOM_IMAGE_ADD_FAILED: 'Failed to add custom image',
  BASS_NOTIFICATION_CUSTOM_IMAGE_DELETE_SUCCESS: 'Delete custom image successfully',
  BASS_NOTIFICATION_CUSTOM_IMAGE_DELETE_FAILED: 'Failed to delete custom image',
  ...
  BASS_NOTIFICATION_ORGANIZATION_CREATE_SUCCESS: 'Succeed in calling create organization api',
  BASS_NOTIFICATION_ORGANIZATION_CREATE_FAILED: 'Failed to call create organization api',
