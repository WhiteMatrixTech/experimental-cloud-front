...
export async function getPageListOfChainCode(params) {
  return request(`/chainCodes/query`, { method: 'POST', body: params });
}
/**
 * 我的合约 - 合约列表的totalDocs
 */
export async function getPageTotalDocsOfChainCode() {
  return request(`/chainCodes/totalCount`);
}
/**
 * 我的合约 -- 通过 / 驳回
 */
...
export async function getPageListOfRoleData(params) {
  return request(`/strategies/query`, { method: 'POST', body: params });
}
/**
 * 获取策略列表的totalDocs
 */
export async function getRoleDateTotalDocs() {
  return request(`/strategies/totalCount`);
}
/**
 * 新增隐私保护策略
 */
export async function createAndUpdateStrategy(params) {
  return request(`/strategies/post`, { method: 'POST', body: params });
}
/**
 *  修改 隐私保护策略
 */
export async function modifyAndUpdateStrategy(params) {
  return request(`/strategies/update`, { method: 'POST', body: params });
}
...
export async function updateStrategyStatus(params) {
  return request(`/strategies/updateStatus`, { method: 'POST', body: params });
}
...
export async function getPageListOfRoleMember(params) {
  return request(`/strategies/strategyName`, { method: 'POST', body: params });
}
...
export async function updateStrategyMember(params) {
  return request(`/strategies/updateMember`, { method: 'POST', body: params });
}
