...
const cardStyle = [
  {
    ...
    backgroundImage: 'linear-gradient(135deg,#c891ff,#b27cff 35%,#af78ff)',
    boxShadow: '0 6px 10px 0 rgba(175,120,255,.4)',
    marginLeft: 0,
  },
  {
    backgroundColor: '#5078ff',
    backgroundImage: 'linear-gradient(-45deg,#5078ff,#5078ff 78%,#5094ff)',
    boxShadow: '0 6px 10px 0 rgba(80,120,255,.4)',
  },
  {
    backgroundColor: '#00a0ff',
    backgroundImage: 'linear-gradient(-45deg,#00a0ff 62%,#3dbeff)',
    boxShadow: '0 6px 10px 0 rgba(0,160,255,.4)',
  },
  {
    backgroundColor: '#28c896',
    backgroundImage: 'linear-gradient(155deg,#2ce6ac,#28c896 46%)',
    boxShadow: '0 6px 10px 0 rgba(40,200,150,.4)',
  },
  {
    backgroundColor: '#ffaf0f',
    backgroundImage: 'linear-gradient(135deg,#ffd00f,#ffaf0f 20%)',
    boxShadow: '0 6px 10px 0 rgba(255,175,15,.4)',
    marginRight: 0,
  },
];
...
export default function StatisticsCard({
  statisticsList = [{}, {}, {}, {}, {}],
  imgList = [peer, msp, chaincode, block, transaction],
}) {
  return (
